"""appexam_24814 URL Configuration
...
admin.site.site_header = "AppExam"
admin.site.site_title = "AppExam Admin Portal"
admin.site.index_title = "AppExam Admin"

# swagger
api_info = openapi.Info(
    title="AppExam API",
    default_version="v1",
    description="API documentation for AppExam App",
)
